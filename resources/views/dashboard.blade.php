...
<div class="row mb-4">
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card bg-primary text-white border-0 shadow h-100 summary-card" style="border-radius:15px; background: linear-gradient(135deg, #0052D4, #4364F7, #6FB1FC);">
    ...
    <!-- Available Items -->
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card bg-success text-white border-0 shadow h-100 summary-card" style="border-radius:15px; background: linear-gradient(135deg, #11998e, #38ef7d);">
            <div class="card-body position-relative overflow-hidden">
    ...
    <!-- Borrowed Items -->
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card bg-warning text-white border-0 shadow h-100 summary-card" style="border-radius:15px; background: linear-gradient(135deg, #f2994a, #f2c94c);">
            <div class="card-body position-relative overflow-hidden">
    ...
    <!-- Maintenance Items -->
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card bg-danger text-white border-0 shadow h-100 summary-card" style="border-radius:15px; background: linear-gradient(135deg, #e60000, #9b2c9b);">
            <div class="card-body position-relative overflow-hidden">
...
<div class="row mb-4">
    <div class="col-md-3 mb-3">
        <div class="card h-100 border-0 shadow-sm rounded-4 hover-shadow-sm transition-all text-center p-3">
    ...
    <div class="col-md-3 mb-3">
        <div class="card h-100 border-0 shadow-sm rounded-4 hover-shadow-sm transition-all text-center p-3" style="{{ $overdueBorrowings->count() > 0 ? 'border-bottom: 5px solid #dc3545 !important;' : '' }}">
