...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h3><i class="fas fa-tags me-2 text-danger"></i>Detail Kategori</h3>
        <p class="text-muted mb-0 small">Informasi lengkap kategori barang</p>
    </div>
    <div class="d-flex gap-2">
        <a href="{{ route('categories.edit', $category) }}" class="btn btn-warning rounded-pill px-4 shadow-sm fw-semibold hover-lift text-dark">
            <i class="fas fa-edit me-1"></i> Edit
        </a>
        <a href="{{ route('categories.index') }}" class="btn btn-light rounded-pill px-4 shadow-sm fw-semibold hover-lift">
        ...
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4 p-md-5">
                <div class="d-flex align-items-center mb-5 p-4 rounded-4" style="background:linear-gradient(135deg, rgba(230,0,0,0.03), rgba(155,44,155,0.03)); border: 1px solid rgba(230,0,0,0.05);">
                    ...
                    <div>
                        <h3 class="mb-2 fw-bold text-dark">{{ $category->name }}</h3>
                        <span class="badge rounded-pill bg-danger shadow-sm px-3 py-2 fw-semibold">
                            <i class="fas fa-box me-1"></i> {{ $category->items->count() }} barang dalam kategori
                        </span>
                    </div>
                </div>
                    ...
                    <table class="table table-borderless align-middle">
                        <tbody>
                            <tr class="border-bottom border-light">
                                <td width="35%" class="text-muted fw-semibold py-3 text-uppercase small tracking-wide"><i class="fas fa-tag me-2 text-danger"></i>Nama Kategori</td>
                                <td class="py-3"><span class="fw-bold fs-6 text-dark">{{ $category->name }}</span></td>
                            </tr>
                            <tr class="border-bottom border-light">
                            ...
                            <tr>
                                ...
                                <td class="py-3"><span class="badge bg-danger rounded-pill shadow-sm px-3">{{ $category->items->count() }} barang</span></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="mt-4 mb-5">
                    <h6 class="fw-bold mb-3 d-flex align-items-center text-dark">
                        <i class="fas fa-box-open text-danger me-2"></i> Daftar Barang di Kategori Ini
                    </h6>
                    ...
                    @else
                        <div class="text-center p-4 border rounded-3 bg-light">
                            ...
                            <p class="text-muted small mb-0">Kategori ini belum memiliki barang.</p>
                        </div>
                    @endif
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center pt-4 border-top">
                    ...
                    <a href="{{ route('categories.edit', $category) }}" class="btn btn-danger rounded-pill px-5 shadow-sm fw-semibold hover-lift" style="background:linear-gradient(135deg, #e60000, #9b2c9b); border:none;">
