...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h3><i class="fas fa-plus me-2 text-danger"></i>Tambah Kategori</h3>
        <p class="text-muted mb-0 small">Tambahkan kategori baru untuk barang inventaris</p>
    </div>
                ...
                <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea class="form-control premium-input @error('description') is-invalid @enderror"
                                  ...
                                  name="description"
                                  rows="4"
                                  placeholder="Deskripsi kategori barang (opsional)">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
