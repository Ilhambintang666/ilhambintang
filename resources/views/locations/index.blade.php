...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h3><i class="fas fa-map-marker-alt me-2 text-danger"></i>Kelola Lokasi</h3>
        <p class="text-muted mb-0 small">Kelola seluruh lokasi penyimpanan barang inventaris PMI</p>
    </div>
    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center py-3">
                ...
                <span class="badge bg-danger rounded-pill">{{ $locations->count() }} Lokasi</span>
            </div>
            <div class="card-body p-0">
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="bg-light">
                                <tr style="border-bottom: 2px solid #e60000;">
                                    ...
                                    <th style="font-size:0.82rem; text-transform:uppercase; letter-spacing:.5px; padding:16px 12px; color:#333; font-weight:600;">Nama Lokasi</th>
                                    ...
                                    <th style="font-size:0.82rem; text-transform:uppercase; letter-spacing:.5px; padding:16px 12px; color:#333; font-weight:600;">Jumlah Barang</th>
                                ...
                                <tr style="transition: all 0.3s;" class="hover-shadow-row">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-3"
                                                style="width:36px;height:36px;border-radius:8px;background:linear-gradient(135deg,#e60000,#9b2c9b);display:flex;align-items:center;justify-content:center;color:#fff;flex-shrink:0;">
                                    ...
                                    <td>
                                        <span class="badge bg-danger rounded-pill">{{ $location->items->count() }} barang</span>
                                    </td>
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <h5 class="text-muted fw-bold">Belum ada lokasi</h5>
                        <p class="text-muted small mb-4">Mulai dengan menambahkan lokasi penyimpanan pertama</p>
                        <a href="{{ route('locations.create') }}" class="btn btn-danger rounded-pill px-4 shadow-sm" style="background:linear-gradient(135deg, #e60000, #9b2c9b); border:none;">
