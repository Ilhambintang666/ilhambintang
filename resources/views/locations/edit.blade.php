...
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h3><i class="fas fa-edit me-2 text-danger"></i>Edit Lokasi</h3>
        <p class="text-muted mb-0 small">Perbarui data lokasi penyimpanan</p>
    </div>
                ...
                <form action="{{ route('locations.update', $location) }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea class="form-control premium-input @error('description') is-invalid @enderror"
                                  ...
                                  name="description"
                                  rows="4"
                                  placeholder="Deskripsi lokasi penyimpanan (opsional)">{{ old('description', $location->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
